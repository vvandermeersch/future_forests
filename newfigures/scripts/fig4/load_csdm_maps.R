...
plan(sequential);gc()
saveRDS(sim_fitness, file = file.path(wd,"newfigures","data","maps", paste0(species, "_", type, "_fitness_", scenario, ".rds")))
...
plan(sequential);gc()
saveRDS(sim_agreement, file = file.path(wd,"newfigures","data","maps", paste0(species, "_", type, "_agreement_", scenario, ".rds")))
