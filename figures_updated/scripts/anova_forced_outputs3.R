...
trend_unc <- simulations %>%
  ...
  theme(
    ...
    axis.title.x = element_blank(), legend.text = element_text(size = 7),
    axis.text.x = element_text(size = 7), axis.text.y = element_text(size = 6.5),
