...
```{r EPBM_simulations, fig.height = 200, fig.cap = "Fitness change, relative to 1970-2000.", dev = "cairo_pdf"}
...
```{r fagus_cascade, fig.height = 120, fig.width = 180, fig.cap = "Fagus sylvatica, ssp2", dev = "cairo_pdf", eval = TRUE}
...
if(reload_data){
  ...
  simulations_pbm <- readRDS(file = file.path(wd,"figures_updated","data", "sim_ecoregions", paste0("pbm_", species, "_all", ".rds")))
  simulations_csdm <- readRDS(file = file.path(wd,"figures_updated","data", "sim_ecoregions", paste0("csdm_", species, "_all", ".rds")))
}
...
```{r EPBM_simulations_abies, fig.height = 200, fig.cap = "Fitness change, relative to 1970-2000.", dev = "cairo_pdf"}
...
```{r abies_cascade, fig.height = 120, fig.width = 180, fig.cap = "Abies alba, ssp2", dev = "cairo_pdf", eval = TRUE}
...
if(reload_data){
  ...
  ncores <- 3
  source(file.path(wd, "figures_updated", "scripts", "load_yearly_fitness_all.R"))
  saveRDS(simulations_pbm, file.path(wd,"figures_updated","data", "sim_ecoregions", paste0("pbm_", species, "_all", ".rds")))

  source(file.path(wd, "figures_updated", "scripts", "load_yearly_fitness_csdm_all.R"))
  saveRDS(simulations_csdm, file.path(wd,"figures_updated","data", "sim_ecoregions", paste0("csdm_", species, "_all", ".rds")))
...
```{r FPBM_simulations_quercusrobur, fig.height = 75, fig.cap = "Fitness change, relative to 1970-2000.", dev = "cairo_pdf"}
...
```{r EPBM_simulations_quercusrobur, fig.height = 200, fig.cap = "Fitness change, relative to 1970-2000.", dev = "cairo_pdf"}
...
```{r CSDM_simulations_quercusrobur, fig.height = 75, fig.cap = "CSDM. Fitness change, relative to 1970-2000.", dev = "cairo_pdf"}
...
```{r quercusrobur_cascade, fig.height = 120, fig.width = 180, fig.cap = "Quercus robur, ssp2", dev = "cairo_pdf", eval = TRUE}
...
```{r FPBM_simulations_quercuspubescens, fig.height = 75, fig.cap = "Fitness change, relative to 1970-2000.", dev = "cairo_pdf"}
...
```{r EPBM_simulations_quercuspubescens, fig.height = 200, fig.cap = "Fitness change, relative to 1970-2000.", dev = "cairo_pdf"}
...
```{r CSDM_simulations_quercuspubescens, fig.height = 75, fig.cap = "CSDM. Fitness change, relative to 1970-2000.", dev = "cairo_pdf"}
...
```{r quercuspubescens_cascade, fig.height = 120, fig.width = 180, fig.cap = "Quercus pubescens, ssp2", dev = "cairo_pdf", eval = TRUE}
...
```{r FPBM_simulations_quercusilex, fig.height = 75, fig.cap = "Fitness change, relative to 1970-2000.", dev = "cairo_pdf", eval = TRUE}
...
```{r EPBM_simulations_quercusilex, fig.height = 200, fig.cap = "Fitness change, relative to 1970-2000.", dev = "cairo_pdf", eval = TRUE}
...
```{r CSDM_simulations_quercusilex, fig.height = 75, fig.cap = "CSDM. Fitness change, relative to 1970-2000.", dev = "cairo_pdf", eval = TRUE}
...
```{r quercusilex_cascade, fig.height = 120, fig.width = 180, fig.cap = "Quercus ilex, ssp2", dev = "cairo_pdf", eval = TRUE}
