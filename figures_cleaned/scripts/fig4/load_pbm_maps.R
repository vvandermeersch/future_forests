...
plan(sequential);gc() 
saveRDS(sim_distribution, file = file.path(wd,"figures_cleaned","data","maps", paste0(species, "_", type, "_distribution_", scenario, ".rds")))
...
saveRDS(sim_dist_2090, file = file.path(wd,"figures_cleaned","data","maps", paste0(species, "_", type, "_2090_dist_", scenario, ".rds")))
