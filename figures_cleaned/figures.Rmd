...
```{r fagus_fittedPEM_simulations, dev = "cairo_pdf", eval = TRUE}
...
```{r fagus_CSDM_simulations, dev = "cairo_pdf", eval = TRUE}
...
```{r fagus_partialPEM_simulations, dev = "cairo_pdf", eval = TRUE}
...
```{r fagus_cascade, fig.height = 160, fig.width = 190, fig.cap = "Fagus sylvatica, ssp2", dev = "cairo_pdf", eval = TRUE}
...
```{r cascade_bonus, fig.height = 60, fig.width = 170, eval = TRUE}
...
```{r load_ecoregions, eval = FALSE}

source(file.path(wd, "figures_cleaned", "scripts", "ecoregions.R"))

```

```{r anova_across_species_byecoregion, fig.height = 120, fig.width = 160, fig.cap = "ANOVA-based partitioning across species", dev = "cairo_pdf", eval = FALSE}
...
```{r anova_across_species_bycell, fig.height = 70, fig.width = 165, fig.cap = "ANOVA-based partitioning across species", dev = "cairo_pdf", eval = FALSE}
...
```{r anova_within_species_byecoregion, fig.height = 100, fig.width = 80, fig.cap = "ANOVA-based partitioning within species", dev = "cairo_pdf", eval = FALSE}
...
```{r fagus_distributions, fig.height = 110, fig.width = 145, dev = "cairo_pdf", eval = TRUE}
