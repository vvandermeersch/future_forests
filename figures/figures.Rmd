...
```{r global_distribution_ssp245, fig.height = 150, fig.cap = "Fitness change relative to 1970-2000 + range shifts (SSP245)", dev = "cairo_pdf"}

# process maps
source(file.path(wd, "figures", "scripts", "distribution_maps.R"))
plot_grid(fitness_maps, distribution_maps, nrow = 2)
...
```{r global_distribution_ssp585, fig.height = 150, fig.cap = "Fitness change relative to 1970-2000 + range shifts (SSP585)", dev = "cairo_pdf"}
...
```{r raw_we, fig.height = 60, fig.cap = "ANOVA on raw outputs (21-year average fitness)", eval = FALSE}
...
country <- c("France", "United Kingdom", "Ireland", "Belgium", "Netherlands", "Andorra", "Spain", "Italy")
...
```{r global_fitness_ssp245_qrob, fig.height = 75, fig.cap = "Fitness change, relative to 1970-2000.", dev = "cairo_pdf"}
reload_data <- FALSE
...
```{r global_distribution_ssp245_qrob, fig.height = 150, fig.cap = "Fitness change relative to 1970-2000 + range shifts (SSP245)", dev = "cairo_pdf"}
...
```{r global_fitness_ssp585_qrob, fig.height = 75, fig.cap = "Fitness change, relative to 1970-2000.", dev = "cairo_pdf"}
reload_data <- FALSE
breakseq <- seq(0, 50, 10)
...
```{r global_distribution_ssp585_qrob, fig.height = 150, fig.cap = "Fitness change relative to 1970-2000 + range shifts (SSP245)", dev = "cairo_pdf"}
...
```{r raw, fig.height = 60, fig.cap = "ANOVA on raw outputs (21-year average fitness)", eval = FALSE}
...
```{r uncertainty_cascade, fig.height = 130, fig.width = 70, fig.cap = "Uncertainty cascade", eval = FALSE}
