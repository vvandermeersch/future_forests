...
saveRDS(sim_fitness, file = file.path(wd,"figures","data","maps", species, "expert", paste0("fitness_", scenario, ".rds")))
...
saveRDS(sim_distribution, file = file.path(wd,"figures","data","maps", species, "expert", paste0("distribution_", scenario, ".rds")))
